		...
		<td style="width: 100%">
			...
			<table class="allborders" style="width: 50%; font-size: 6pt;"  cellspacing="0" cellpadding="1">
				<tr style="line-height:5px;">
					<td style="text-align: left; padding-left: 10px; font-weight: bold; width: 30%">{l s='Tax Detail' pdf='true'}</td>
					...
					{if !$use_one_after_another_method}
						<td style="text-align: right; padding-left: 10px; font-weight: bold; width: 30%">{l s='Total Tax Excl' pdf='true'}</td>
					{/if}
					<td style="text-align: right; padding-left: 10px; font-weight: bold; width: 20%">{l s='Total Tax' pdf='true'}</td>
				</tr>
				...
				{if isset($product_tax_breakdown)}
					...
					<tr style="line-height:6px;">
					 ...
					 <td style="width: 20%; text-align: right;">{$rate|number_format:1} %</td>
					{if !$use_one_after_another_method}
					...
					<tr style="line-height:6px;">
					 ...
					 <td style="width: 20%; text-align: right;">{$shipping_tax_infos.rate|number_format:1} %</td>
					{if !$use_one_after_another_method}
