...
// polia do vonkajsej tabulky (zoznamu zakaznikov)        
...
/*			'address1' => array(
				'title' => $this->l('Adresa(riadok 1.)'),
				'width' => 'auto'
			),
			'address2' => array(
				'title' => $this->l('Adresa(riadok 2.)'),
				'width' => 'auto'
			),
*/            
			'email' => array(
...
// polia pre formular pridavania / editovania             
			'input' => array(
/*
				array(
					'type' => 'radio',
...
/*				array(
					...
					'name' => 'passwd',
					'size' => 33,
					'required' => false, //($obj->id ? false : true),
...
*/                
				...
				array(
					'type' => 'text',
					'label' => $this->l('Automatická splatnosť:'),
					'name' => 'splatnost',
					'size' => 33,
					'required' => false,
					'hint' => $this->l('Uveďte počet dní splatnosti pre tohdo zákazníka. Ak toto nezadáte bude nutné voliť splatnosť ručne prípadne nechať systém použiť dnešný dátum (pre prípad hotovosti).')
				),
