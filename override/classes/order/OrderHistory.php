...
*/
	 ...
	 */
	public static function getLastOrderState2($id_order)
	{
    ...
    public function check(){
        $sql = 'SELECT * FROM `'._DB_PREFIX_.'order_history` WHERE id_order = '.$this->id_order.' AND id_order_state = '.$this->id_order_state;
