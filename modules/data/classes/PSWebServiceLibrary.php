...
//            $xml = new SimpleXMLExtended($response);            
			if (libxml_get_errors())
			{
				$msg = var_export(libxml_get_errors(), true);
				libxml_clear_errors();                
//				throw new PrestaShopWebserviceException('Response:'.$response.'<br/><br/>HTTP XML response is not parsable: '.$msg);
//var_dump($resp);
				throw new PrestaShopWebserviceException('<br/><br/>HTTP XML response is not parsable: '.$msg);
			}
			return $xml;
		}
		else
