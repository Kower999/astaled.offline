...
{/if}
	...
	<tr class="filter">
        ...
        <td class="center">
            <b>{if $total2}{$total2}{else}0{/if}</b>
        </td>
        <td class="right">
            <b>{if $total}{displayPrice price=$total currency=$currency->id}{else}0,0{/if}</b>
        </td>
        <td colspan="10"></td>
    </tr>
	...
	<tr class="filter">
        ...
        <td class="center">
            <b>{if isset($total3)}{$total3}{else}0{/if}</b>
        </td>
        <td class="right">
            <b>{if isset($total4)}{displayPrice price=$total4 currency=$currency->id}{else}0,0{/if}</b>
        </td>
        <td colspan="10"></td>
    </tr>
</tbody>
