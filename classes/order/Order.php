...
*/
	...
	*/
	...
	{
		if (empty($id_order_state) || (int)$this->current_state == (int)$id_order_state)
			return false;
		$history = new OrderHistory();
		$history->id_order = (int)$this->id;
	...
	public function addWs($autodate = false, $nullValues = false)
	{
...
//		$paymentModule->validateOrder($this->id_cart, Configuration::get('PS_OS_WS_PAYMENT'), $this->total_paid, $this->payment, null, array(), null, false, $customer->secure_key);
		$paymentModule->validateOrder($this->id_cart, $this->current_state , $this->total_paid, $this->payment, null, array(), null, false, $customer->secure_key, null, false, $this);
//var_dump($customer);        
