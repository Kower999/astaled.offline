...
//	public $phone;    
	...
	public static $definition = array(
		...
		'fields' => array(
			...
			'company' =>					array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => true,  'size' => 64),
//			'address1' => 					array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 64),
//			'address2' => 					array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 64),
//			'ico' => 					    array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 32),
//			'dic' => 					    array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 32),
//			'icdph' => 					    array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 32),
//			'phone' => 					    array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => false, 'size' => 32),
			...
			'splatnost' =>				    array('type' => self::TYPE_INT, 'validate' => 'isUnsignedId'),
		),
	);
	...
	public function add($autodate = true, $null_values = true)
	{
        ...
        if($employee)
        if ($employee->isLoggedBack()) $this->id_employee = Context::getContext()->employee->id; 
	...
	public static function getCustomers()
	{
        if(Context::getContext()->employee->isLoggedBack() && (Context::getContext()->employee->id_profile == 5)) {
		  $sql = 'SELECT `id_customer`, `email`, `firstname`, `lastname`
				...
				WHERE id_employee = '.Context::getContext()->employee->id.' '.Shop::addSqlRestriction(Shop::SHARE_CUSTOMER).'
        ...
        if(Context::getContext()->employee->isLoggedBack() && (Context::getContext()->employee->id_profile == 5)) {
	      $sql = 'SELECT *
				...
				WHERE (
					...
					) AND id_employee = '.Context::getContext()->employee->id.' '.Shop::addSqlRestriction(Shop::SHARE_CUSTOMER);
        } else {
	      $sql = 'SELECT *
				FROM `'._DB_PREFIX_.'customer`
				WHERE (
