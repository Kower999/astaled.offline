<?php /* Smarty version Smarty-3.1.8, created on 2015-01-30 21:26:17
         compiled from "/var/www/virtual/esystem.sk/htdocs/clients/astaledonline/override/controllers/admin/templates/orders/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:206002205154cbe8e91e31b9-09858272%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0244eabb03d29ba73a7c9084a3fbe0099364ebc8' => 
    array (
      0 => '/var/www/virtual/esystem.sk/htdocs/clients/astaledonline/override/controllers/admin/templates/orders/form.tpl',
      1 => 1422642927,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '206002205154cbe8e91e31b9-09858272',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cbe8e9719359_50241765',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cbe8e9719359_50241765')) {function content_54cbe8e9719359_50241765($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/virtual/esystem.sk/htdocs/clients/astaledonline/tools/smarty/plugins/modifier.escape.php';
?>
...
');
    ...
    function calcProvizia(product)
    {
        ...
        if( cena >= cena2){
            var provizia = cena * prov / 100; 
        } else {
            var provizia = (cena - ws) / 2;
...
<fieldset id="products_part" style="display:none;"><legend><img src="../img/t/AdminCatalog.gif" /><?php echo smartyTranslate(array('s'=>'Košík'),$_smarty_tpl);?>
	...
	<div>
		...
		<div class="margin-form">
			...
			<p><?php echo smartyTranslate(array('s'=>'Hladať produkt napísaním prvých písmen (min 3)'),$_smarty_tpl);?>
</p>
		</div>
...
" />
			...
			<p><label for="qty"><?php echo smartyTranslate(array('s'=>'Množstvo:'),$_smarty_tpl);?>
</label><input type="text" name="qty" id="qty" value="1" />&nbsp;<b><?php echo smartyTranslate(array('s'=>'Na sklade:'),$_smarty_tpl);?>
...
<fieldset id="summary_part" style="display:none;">
	...
	<div id="cart_summary" style="clear:both;float:left;">
		<ul>
			...
			<li><span class="total_cart"><?php echo smartyTranslate(array('s'=>'Provízia za objednávku:'),$_smarty_tpl);?>
