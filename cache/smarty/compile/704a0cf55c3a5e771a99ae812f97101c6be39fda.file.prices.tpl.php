<?php /* Smarty version Smarty-3.1.8, created on 2015-12-11 21:16:42
         compiled from "C:\wamp\www\shopadmin/themes/default\template\controllers\products\prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2756954f482a1f1d1c8-59287109%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '704a0cf55c3a5e771a99ae812f97101c6be39fda' => 
    array (
      0 => 'C:\\wamp\\www\\shopadmin/themes/default\\template\\controllers\\products\\prices.tpl',
      1 => 1449864993,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2756954f482a1f1d1c8-59287109',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_54f482a236a926_49411679',
  'variables' => 
  array (
    'link' => 0,
    'ecotax_tax_excl' => 0,
...
<?php if ($_valid && !is_callable('content_54f482a236a926_49411679')) {function content_54f482a236a926_49411679($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<table>
	<tr>
		<td class="col-left">
			<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('field'=>"cena_2",'type'=>"default"), 0);?>

			<label><?php echo smartyTranslate(array('s'=>'Hraničná cena:'),$_smarty_tpl);?>
</label>
		</td>
		<td style="padding-bottom:5px;">
			<?php echo $_smarty_tpl->tpl_vars['currency']->value->prefix;?>
<input size="11" maxlength="14" name="cena_2" id="cena_2" type="text" value="<?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['toolsConvertPrice'][0][0]->toolsConvertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value->cena_2),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php echo sprintf('%.2f',$_tmp3);?>
" onchange="this.value = this.value.replace(/,/g, '.');" /><?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>

			<p class="preference_description"><?php echo smartyTranslate(array('s'=>'Spodná hraničná cena'),$_smarty_tpl);?>
</p>
		</td>
	</tr>
	...
	<tr>
		<td class="col-left">
			<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('field'=>"provizia",'type'=>"default"), 0);?>

			<label><?php echo smartyTranslate(array('s'=>'Provízia:'),$_smarty_tpl);?>
</label>
		</td>
		<td style="padding-bottom:5px;">
			<input size="11" maxlength="14" name="provizia" id="provizia" type="text" value="<?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['toolsConvertPrice'][0][0]->toolsConvertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value->provizia),$_smarty_tpl);?>
<?php $_tmp4=ob_get_clean();?><?php echo sprintf('%.2f',$_tmp4);?>
