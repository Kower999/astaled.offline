<?php /* Smarty version Smarty-3.1.8, created on 2015-12-28 15:08:56
         compiled from "C:\wamp\www\modules\data\views\templates\admin\statistika1\helpers\list\list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2468654fc3569c69a40-02560688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7cf7300fa990514b096fa476c7ced1cbd22e575' => 
    array (
      0 => 'C:\\wamp\\www\\modules\\data\\views\\templates\\admin\\statistika1\\helpers\\list\\list_content.tpl',
      1 => 1449845383,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2468654fc3569c69a40-02560688',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_54fc356a035674_98345804',
  'variables' => 
  array (
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_54fc356a035674_98345804')) {function content_54fc356a035674_98345804($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\tools\\smarty\\plugins\\modifier.escape.php';
?>
<tbody>
...
<?php }?>
	...
	<tr class="filter">
        ...
        <td class="center">
            <b><?php if ($_smarty_tpl->tpl_vars['total2']->value){?><?php echo $_smarty_tpl->tpl_vars['total2']->value;?>
<?php }else{ ?>0<?php }?></b>
        </td>
        <td class="right">
            <b><?php if ($_smarty_tpl->tpl_vars['total']->value){?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total']->value,'currency'=>$_smarty_tpl->tpl_vars['currency']->value->id),$_smarty_tpl);?>
<?php }else{ ?>0,0<?php }?></b>
        </td>
        <td colspan="10"></td>
    </tr>
	...
	<tr class="filter">
        ...
        <td class="center">
            <b><?php if (isset($_smarty_tpl->tpl_vars['total3']->value)){?><?php echo $_smarty_tpl->tpl_vars['total3']->value;?>
<?php }else{ ?>0<?php }?></b>
        </td>
        <td class="right">
            <b><?php if (isset($_smarty_tpl->tpl_vars['total4']->value)){?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total4']->value,'currency'=>$_smarty_tpl->tpl_vars['currency']->value->id),$_smarty_tpl);?>
<?php }else{ ?>0,0<?php }?></b>
        </td>
        <td colspan="10"></td>
    </tr>
