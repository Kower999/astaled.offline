<?php /* Smarty version Smarty-3.1.8, created on 2013-03-13 19:38:00
         compiled from "/var/www/virtual/astaled.sk/htdocs/shopadmin/themes/default/template/controllers/carts/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16016326675130844aee42f5-38122464%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79615c55e0c13768089a5d47603a45c084957bb7' => 
    array (
      0 => '/var/www/virtual/astaled.sk/htdocs/shopadmin/themes/default/template/controllers/carts/helpers/view/view.tpl',
      1 => 1356963554,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16016326675130844aee42f5-38122464',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5130844b837d15_11293938',
  'variables' => 
  array (
    'show_toolbar' => 0,
    'toolbar_btn' => 0,
...
<?php if ($_valid && !is_callable('content_5130844b837d15_11293938')) {function content_5130844b837d15_11293938($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/virtual/astaled.sk/htdocs/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_function_math')) include '/var/www/virtual/astaled.sk/htdocs/tools/smarty/plugins/function.math.php';
?>
...
<br /><br /><br /><br />
		<?php }else{ ?>
			<?php echo smartyTranslate(array('s'=>'No order created from this cart'),$_smarty_tpl);?>
</span>
...
&addorder"><?php echo smartyTranslate(array('s'=>'Create an order with from cart'),$_smarty_tpl);?>
</a></p><?php }?>
		<?php }?>
	</div>
	<br style="clear:both;" />
...
<?php }?>
		...
		<?php if ($_smarty_tpl->tpl_vars['total_discounts']->value!=0){?>
			<tr class="cart_total_voucher">
				<td colspan="5"><?php echo smartyTranslate(array('s'=>'Total vouchers:'),$_smarty_tpl);?>
</td>
		...
		<?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value>0){?>
			<tr class="cart_total_voucher">
				<td colspan="5"><?php echo smartyTranslate(array('s'=>'Total gift-wrapping:'),$_smarty_tpl);?>
</td>
...
&updatediscount"><?php echo $_smarty_tpl->tpl_vars['discount']->value['name'];?>
	...
	<?php echo smartyTranslate(array('s'=>'For this customer\'s group, prices are displayed as:'),$_smarty_tpl);?>
 <b><?php if ($_smarty_tpl->tpl_vars['order']->value->getTaxCalculationMethod()==@PS_TAX_EXC){?><?php echo smartyTranslate(array('s'=>'tax excluded'),$_smarty_tpl);?>
