<?php /* Smarty version Smarty-3.1.8, created on 2014-10-10 01:30:03
         compiled from "G:\WEB WORK\esystems\astaled\UwAmp\UwAmp\www\shopadmin/themes/default\template\helpers\list\list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1341054371a7b41cdb0-71860690%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '531ab9a5de3071c2880f0cc2224c32ad762bfe30' => 
    array (
      0 => 'G:\\WEB WORK\\esystems\\astaled\\UwAmp\\UwAmp\\www\\shopadmin/themes/default\\template\\helpers\\list\\list_content.tpl',
      1 => 1412842281,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1341054371a7b41cdb0-71860690',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54371a7c188e95_55252830',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54371a7c188e95_55252830')) {function content_54371a7c188e95_55252830($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'G:\\WEB WORK\\esystems\\astaled\\UwAmp\\UwAmp\\www\\tools\\smarty\\plugins\\modifier.escape.php';
if (!is_callable('smarty_function_mycount')) include 'G:\\WEB WORK\\esystems\\astaled\\UwAmp\\UwAmp\\www\\tools\\smarty\\plugins\\function.mycount.php';
?>
<tbody>
...
$_smarty_tpl->tpl_vars['mytotal']->value[] = substr($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value],0,-4);?> 
    <?php }?>        
	<?php if (isset($_smarty_tpl->tpl_vars['params']->value['tprice'])){?>
        <?php $_smarty_tpl->createLocalArrayVariable('mytotal2', null, 0);
$_smarty_tpl->tpl_vars['mytotal2']->value[] = substr($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value],0,-4);?> 
    <?php }?>        
...
<?php $_smarty_tpl->tpl_vars['total'] = new Smarty_variable(0.0, null, 0);?>
	<tr class="filter">
        <td colspan="<?php if ($_smarty_tpl->tpl_vars['oz']->value){?>6<?php }else{ ?>7<?php }?>">&nbsp;&nbsp;&nbsp;<b>Suma</b></td>
        <td class="right">
            <b><?php echo smarty_function_mycount(array('this'=>$_smarty_tpl->tpl_vars['mytotal2']->value),$_smarty_tpl);?>
</b>
        </td>
        <td class="right">
            <b><?php echo smarty_function_mycount(array('this'=>$_smarty_tpl->tpl_vars['mytotal']->value),$_smarty_tpl);?>
</b>
        </td>
        <td colspan="3"></td>
    </tr>
