<?php /* Smarty version Smarty-3.1.8, created on 2015-02-25 16:58:24
         compiled from "C:\wamp\www\themes\default\pdf\delivery-slip.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3169054da7a28cfe6a8-42189908%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3169054da7a28cfe6a8-42189908',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_54da7a28efd955_49355553',
  'variables' => 
  array (
    'address' => 0,
    'country' => 0,
...
<?php if ($_valid && !is_callable('content_54da7a28efd955_49355553')) {function content_54da7a28efd955_49355553($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\tools\\smarty\\plugins\\modifier.escape.php';
		...
		<td style="width: 100%; text-align: right">
			<table class="allborders" style="width: 100%; font-size: 6pt;" cellspacing="0" cellpadding="3">
				<tr style="line-height:4px;">
				    <td style="background-color: #6D6D6D; color: #FFF; text-align: left; font-weight: bold; width: 11%"><?php echo smartyTranslate(array('s'=>'EAN','pdf'=>'true'),$_smarty_tpl);?>
</td>
					<td style="text-align: left; background-color: #6D6D6D; color: #FFF; padding-left: 10px; font-weight: bold; width: 82%"><?php echo smartyTranslate(array('s'=>'Product','pdf'=>'true'),$_smarty_tpl);?>
</td>
...
;">
					<td style="text-align: left; width: 11%"><?php if (isset($_smarty_tpl->tpl_vars['order_detail']->value['product_ean13'])&&!empty($_smarty_tpl->tpl_vars['order_detail']->value['product_ean13'])){?><?php echo $_smarty_tpl->tpl_vars['order_detail']->value['product_ean13'];?>
<?php }?></td>
					<td style="text-align: left; width: 82% "><?php echo $_smarty_tpl->tpl_vars['order_detail']->value['product_name'];?>
</td>
