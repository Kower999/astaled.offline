<?php /* Smarty version Smarty-3.1.8, created on 2014-10-10 22:50:39
         compiled from "G:\WEB WORK\esystems\astaled\UwAmp\UwAmp\www\shopadmin/themes/default\template\controllers\orders\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:238095438469fa2d701-01116962%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c563edc17a4b67543806e9ddb4380552e97f5d2f' => 
    array (
      0 => 'G:\\WEB WORK\\esystems\\astaled\\UwAmp\\UwAmp\\www\\shopadmin/themes/default\\template\\controllers\\orders\\form.tpl',
      1 => 1412842278,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '238095438469fa2d701-01116962',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_543846a08c30a4_83518034',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543846a08c30a4_83518034')) {function content_543846a08c30a4_83518034($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'G:\\WEB WORK\\esystems\\astaled\\UwAmp\\UwAmp\\www\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
');
	...
	function updateCartProducts(products, gifts, id_address_delivery)
	{
		...
		$.each(products, function() {
			...
			cart_content += '</td><td>'+this.total_wt+'&nbsp;<span class="currency_sign"></span></td></tr>';
...
<fieldset id="customer_part">
	...
	<div class="margin-form">
		...
		<p><?php echo smartyTranslate(array('s'=>'Search a customer by tapping the first letters of his name'),$_smarty_tpl);?>
</p>
...
<fieldset id="products_part" style="display:none;"><legend><img src="../img/t/AdminCatalog.gif" /><?php echo smartyTranslate(array('s'=>'Cart'),$_smarty_tpl);?>
	...
	<div>
		...
		<div class="margin-form">
			...
			<p><?php echo smartyTranslate(array('s'=>'Search a product by tapping the first letters of his name'),$_smarty_tpl);?>
</p>
		</div>
		...
		<table cellspacing="0" cellpadding="0" class="table width5" id="customer_cart">
			...
			<thead>
				<tr>
					...
					<th style="width: 80px;"><?php echo smartyTranslate(array('s'=>'Cena s DPH'),$_smarty_tpl);?>
</th>
				</tr>
			</thead>
			<tbody>
...
<fieldset id="vouchers_part" style="display:none;">
	...
	<p>
		<label><?php echo smartyTranslate(array('s'=>'Search a voucher:'),$_smarty_tpl);?>
 </label>
...
&addaddress&id_customer=42&liteDisplaying=1&submitFormAjax=1#"><img src="../img/admin/add.gif" title="new"/><?php echo smartyTranslate(array('s'=>'Add new address'),$_smarty_tpl);?>
</a>
</fieldset>
<br />
