		...
		{if $display_footer}
				...
				<div id="footer">
					...
					<div class="footerLeft" style="margin-left: 15px;">
						<span>Dátum vystavenia poslednej výdajky: {$LAST_STOCK_UPDATE}</span><br />
						<span>Posledná aktualizácia databázy produktov: {$LAST_UPDATE_PRODUCTS_VERSION}</span>
					</div>
					<div class="footerLeft" style="margin-left: 15px;">
						<span>Atuálna verzia systému: {$LAST_UPDATE_VERSION}</span><br />
					</div>
