...
{*$list|@var_dump}
{*$test2|@var_dump*}
{assign var=mytotal value=[]}
{assign var=mytotal2 value=[]}
...
{*$total = 0.0*}
	<tr class="filter">
        <td colspan="{if $oz}5{else}6{/if}">&nbsp;&nbsp;&nbsp;<b>Suma (strana)</b></td>
        <td class="right">
            <b>{if $mytotal2}{mycount this=$mytotal2}{else}0,0{/if}</b>
        </td>
        <td class="right">
            <b>{if $mytotal}{mycount this=$mytotal}{else}0,0{/if}</b>
        </td>
        <td colspan="7"></td>
    </tr>

	<tr class="filter">
        <td colspan="{if $oz}5{else}6{/if}">&nbsp;&nbsp;&nbsp;<b>Suma (celkom)</b></td>
        <td class="right">
            <b>{if isset($total5)}{displayPrice price=$total5 currency=$currency->id}{else}0,0{/if}</b>
        </td>
        <td class="right">
            <b>{if isset($total6)}{displayPrice price=$total6 currency=$currency->id}{else}0,0{/if}</b>
        </td>
        <td colspan="7"></td>
    </tr>
{/if}    
