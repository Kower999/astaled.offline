...
<script type="text/javascript">
	...
	var txt_hide_carts = '{l s='Hide carts and orders for this customerzz'}';
		...
		<table cellspacing="0" cellpadding="0" class="table width5" id="customer_cart">
			...
			<thead>
				<tr>
					...
					<th style="width: 80px;">{l s='Cena s DPH'}</th>
				</tr>
			</thead>
			<tbody>
			</tbody>
...
<fieldset id="summary_part" style="display:none;">
	...
	<div id="cart_summary" style="clear:both;float:left;">
		<ul>
			...
			<li><span class="total_cart">{l s='Provízia za objednávku:'}</span><span id="total_provisions"></span>&nbsp;&nbsp;<span class="currency_sign"></span></li>
		</ul>
	</div>
