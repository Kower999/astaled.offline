...
echo '			</div>
			...
			<div id="footer">
				<div style="float:left;margin-left:10px;padding-top:6px">
					<a href="#" target="_blank" style="font-weight:700;color:#666666">PrestaShop&trade; '._PS_VERSION_.'</a><br />
...
echo '				| <a href="http://www.prestashop.com/en/contact_us/" target="_blank" class="footer_link">'.translate('Kontakt 0905 609 555').'</a>
